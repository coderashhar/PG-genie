...
export default function PropertyDisplayMap({ lat, lng, address, title }: PropertyDisplayMapProps) {
  ...
  return (
    <div className="relative w-full h-[200px] md:h-[400px] bg-surface-container rounded-xl overflow-hidden border border-outline-variant group">
      {isMapReady ? (
        <GoogleMap
      ...
      {lat && lng && (
        <a
          ...
          className="absolute bottom-6 right-6 z-10 bg-surface px-4 py-2 rounded-lg shadow-md font-label-sm flex items-center gap-2 hover:bg-surface-variant transition-colors border border-outline-variant cursor-pointer text-on-surface"
        >
