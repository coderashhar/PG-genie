  ...
  return (
    <div className="bg-surface-container rounded-xl p-4 md:p-gutter shadow-[0px_4px_20px_rgba(76,29,149,0.05)]">
      <h2 className="font-h2 text-[20px] md:text-h2 text-on-background flex items-center gap-2 mb-4 md:mb-stack-md">
        <span className="material-symbols-outlined text-primary text-[20px] md:text-[24px]">store</span>
      ...
      <form onSubmit={handleSave} className="space-y-4 md:space-y-5">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-5">
          {/* Name */}
          <div>
            <label className="block text-[11px] md:text-label-sm font-label-sm text-on-surface-variant mb-1">Owner Name</label>
          ...
          {/* Business Name */}
          <div>
            <label className="block text-[11px] md:text-label-sm font-label-sm text-on-surface-variant mb-1">Business/PG Name</label>
            <div className="relative">
              <span className="absolute inset-y-0 left-0 flex items-center pl-3 md:pl-4 text-on-surface-variant">
                <span className="material-symbols-outlined text-[18px] md:text-[20px]">business</span>
              </span>
              <input
                type="text"
                name="businessName"
        ...
        {/* Business Address */}
        <div>
          <label className="block text-[11px] md:text-label-sm font-label-sm text-on-surface-variant mb-1">Business Address</label>
          <div className="relative">
            <span className="absolute top-2.5 md:top-3 left-0 flex pl-3 md:pl-4 text-on-surface-variant">
